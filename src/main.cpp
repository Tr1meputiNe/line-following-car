...
// ---- 速度（0~255）----
// 【为什么从 130/135/60 降下来】原来 130 是按"电机接 Arduino 5V"算的，实测那个接法
// 电压会塌到 2.2V，根本跑不动。改成电机单独吃 6V 电池之后，同样的 PWM 值电机快约 20%，
// 所以按比例降一档：110@6V ≈ 132@5V，正好是原来调好的那个速度。
// 顺带好处：如果你先不接线、就地在 5V 上试，速度低一点电流也小一点，有几率能撑住。
int speedFast = 110;     // 直行速度（两个轮子一样）
int speedTurn = 115;     // 转弯时【外侧】轮速度
int speedBack = 50;      // 转弯时【内侧】轮【反转】速度
