...
// ---- 速度（0~255，就是 PWM 占空比）----
// 【本次：整体降约 20%】速度降下来有两个好处：一是转向/过线时不容易冲过头，
// 二是电机电流跟着变小 —— 我们实测过占空比 130 时会把 5V 轨拉到 2.30V，
// 降速能明显减轻这个塌陷。等循迹稳了再一格一格加回去（每次 +10）。
int speedFast = 110;    // 直行速度（两个轮子一样）
int speedTurn = 130;    // 转弯时【外侧】轮速度，越大转得越急
int speedBack = 80;     // 转弯时【内侧】轮【反转】速度，越大转得越急
